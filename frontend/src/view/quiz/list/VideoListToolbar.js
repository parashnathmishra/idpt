    ...
    return (
      <Toolbar>
        ...
        {this.props.hasPermissionToAuditLogs && (
          <Link to="/audit-logs?entityNames=video">
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: videoSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: videoSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(VideoToolbar);
